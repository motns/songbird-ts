 ...
 */
export type ExtractRouteParamsAsList<Route> = Route extends string
 ...
 */
export type RouteParamToPrimitiveTypeObject<Param> = Param extends string
  ? Param extends ""
    ? never
...
export type RouteParamToTypeObject<Param extends string> = [
  RouteParamToPrimitiveTypeObject<Param>,
] extends [never]
  ? never
 ...
 */
export type RouteParamOutput<Route extends string> = MergeArrayOfObjects<
  RouteParamListToTypeObjectList<ExtractRouteParamsAsList<Route>>
>;
...
export type RouteParamOutputType<Route extends string> =
  ExtractRouteParamsAsList<Route> extends [] ? Record<string, never> : RouteParamOutput<Route>;

/**
 * Used to join two Path segments, gracefully handling preceding/trailing slashes
 */
export type RouteConcat<
  A extends string,
  B extends string,
